...
bootloader --timeout=1 --append="console=tty0 console=ttyS0,115200n8 no_timer_check crashkernel=auto net.ifnames=0" --boot-drive=sda
...
# Ensure GRUB is correctly set up for EFI
grub2-mkconfig -o /boot/efi/EFI/rocky/grub.cfg

# Disable cloud-init datasource detection for vagrant
cat > /etc/cloud/cloud.cfg.d/99_disable_datasource.cfg <<EOF
