...
sshkey --username=vagrant "ssh-rsa AAAAB3NzaC1yc..."
...
#part / --fstype="xfs" --mkfsoptions "-m bigtime=0,inobtcount=0" --ondisk=vda --size=22288
bootloader --timeout=1 --append="console=ttyS0,115200n8 no_timer_check crashkernel=auto net.ifnames=0"
...
logvol / --fstype ext4 --vgname system --size=81920 --name=root
